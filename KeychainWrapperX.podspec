Pod::Spec.new do |spec|
  ...
  spec.homepage = "https://github.com/prashantLalShrestha/KeychainWrapperX"
  ...
  # spec.source = { :git => '' }
  spec.source = { 
    :git => "https://github.com/prashantLalShrestha/KeychainWrapperX.git", :tag => spec.version.to_s
  }
